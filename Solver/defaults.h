...
#define FAKE_ARGV { L"-sud=\"Sudokus\\4\\medium\\med02.sud\"", L"-tc=8", L"-par=4", L"-time", L"-st0", L"-st1", L"-st2", L"-st3", L"-st4", L"-st5", L"-st6", L"-st7", L"-st8", L"-st9", L"-st10", L"-st11", L"-st12", L"-st13", L"-st14", L"-st15" }
...
//define to await confirmation on release builds
#define FORCE_KEEPALIVE
